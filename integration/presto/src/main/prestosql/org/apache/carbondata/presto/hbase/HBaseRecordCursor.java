        ...
        implements RecordCursor
{
     ...
     * columnHandles list
     */
    public List<HiveColumnHandle> columnHandles;
    ...
    public HBaseRecordCursor(
            ...
            HBaseSplit hBaseSplit)
    {
        this(columnHandles, columnTypes, serializer, rowIdName, fieldToColumnName, defaultValue, hBaseSplit);
...
//                if (!Utils.contains(hc.getName(), rowIdName)) {
                    ...
                    bytes =
                            row.getValue(
                                hbaseColumn.getCf().getBytes(Charset.forName("UTF-8")),
                                    hc.getName().getBytes(Charset.forName("UTF-8")));
                    if (bytes != null) {
