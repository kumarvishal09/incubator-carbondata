...
public class LocalDictAdaptiveDimColumnPage implements DimensionColumnPage {
  ...
  /**
   * true represents bitset is for null or not null
   */
  private final boolean isNullBitset;
  ...
  public LocalDictAdaptiveDimColumnPage(ColumnPage columnPage, int[] invertedIndex,
    ...
    this.bitSet = columnPage.getNullBits();
    this.isNullBitset = columnPage.isNullBitset();
