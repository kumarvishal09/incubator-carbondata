 ...
 */
public class PrimitiveDimColumnCodec extends IndexStorageCodec {

  private DataType dataType;

  private List<Encoding> encodings;

  public PrimitiveDimColumnCodec(boolean isSort, DataType dataType,
  ...
  @Override public String getName() {
    return "PrimitiveDimColumnCodec";
  }
  ...
  @Override public ColumnPageEncoder createEncoder(Map<String, Object> parameter) {
    return new IndexStorageEncoder(false, null == parameter ?
      ...
      @Override protected void encodeIndexStorage(ColumnPage input)
        ...
        TableSpec.MeasureSpec spec = new
            TableSpec.MeasureSpec(actualPage.getColumnSpec().getFieldName(), dataType);
